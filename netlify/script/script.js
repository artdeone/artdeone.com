...
const promptsData = [
    {
        id: 1,
        title: "Chevrolet Malibu | NEW ROADS",
        model: "Grok, Nano or Powerful Ai Model",
        image: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694706/1_zkpkzm.jpg",
        fullImage: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694706/1_zkpkzm.jpg",
        images: [
            "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694706/1_zkpkzm.jpg",
            "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694706/2_yl64wu.jpg"
        ],
        prompt: "Chevrolet Malibu | NEW ROADS. Act as a Professional Editorial Art Director.\n\nPHASE 1: PHYSICS & GROUNDING (THE \"STABILITY\" RULE).\n- Analyze Chevrolet Malibu category:\n  * CATEGORY B (Automotive): The Chevrolet Malibu must be HEROICALLY GROUNDED. Place the car firmly on a solid surface (asphalt, concrete, or rock).\n  * Perspective: Use an extreme low-angle (worm's-eye view). The car must look massive and dominant, anchored to the bottom of the frame, towering over the viewer. NO floating or flying for vehicles.\n\nPHASE 2: DYNAMIC PHOTOGRAPHY & LIGHTING.\n- Environment: A vast, clear blue sky with minimal soft clouds.\n- Lighting: Natural, direct sunlight. High-contrast shadows on the Chevrolet Malibu to emphasize form and texture.\n- Style: High-end 8k commercial automotive photography. Sharp focus.\n\nPHASE 3: TYPOGRAPHY & LAYOUT (VERTICAL 9:16).\n- Layout: Designed for a narrow vertical frame. Use the text \"NEW ROADS\" as massive, ultra-condensed bold sans-serif characters.\n- Execution: Split \"NEW ROADS\" into two parts: \"NEW\" positioned on the middle-left edge, \"ROADS\" positioned on the middle-right edge.\n- Depth: A part of the Chevrolet Malibu (e.g., the front bumper, a side mirror, or a tire) must overlap the letters to create a 3D effect.\n\nPHASE 4: COLOR STRATEGY (MATTE & REALISTIC).\n- Graphic Color: NO NEON. Use a solid, matte Chevrolet Gold or flat Navy Blue for the text. The color must be opaque and non-glowing, resembling high-quality print ink.\n- Photo Color: Maintain authentic, rich photographic colors for the Chevrolet Malibu and the sky. The contrast comes from \"Flat Graphic vs. Realistic Photo\".\n\nPHASE 5: FINAL BRANDING.\n- Logo: Small minimalist Chevrolet bowtie logo in the upper corner.\n- Metadata: Tiny secondary text in a clean sans-serif font at the bottom for a technical/editorial look. --ar 9:16"
    },

    {
        id: 2,
        title: "Chevrolet Malibu | Bold Tpography",
        model: "Grok, Nano or Powerful Ai Model",
        image: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694721/2_eqadtt.jpg",
        fullImage: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694721/2_eqadtt.jpg",
        prompt: `A pristine white modern Chevrolet Malibu overlapping massive bold typography. Act as a Professional Editorial Automotive Art Director.

                PHASE 1: THE TYPOGRAPHY (CRITICAL ACCURACY).
                - Text elements: Generate two distinct massive, bold, dark navy blue words.
                - Left side text: The exact word "N E W" spelled vertically (stacked letters from top to bottom) running along the extreme left edge of the frame.
                - Right side text: The exact word "R O A D S" spelled vertically (stacked letters from top to bottom) running along the extreme right edge of the frame.
                - Font Style: Clean, sharp, heavy geometric sans-serif font. Flat matte color with no glow.

                PHASE 2: THE SUBJECT & OVERLAP.
                - Subject: A white Chevrolet Malibu parked on smooth concrete ground, filling the lower center of the frame.
                - Perspective: Extreme low-angle (worm's-eye view), making the car look heroic and dynamic.
                - Overlap Effect (3D Depth): The front bumper and the hood of the Chevrolet Malibu MUST physically overlap and cover parts of the "N E W" and "R O A D S" text behind it. The text sits behind the car but in front of the sky.

                PHASE 3: ENVIRONMENT & LIGHTING.
                - Background: A clear, vast blue sky with soft minimal clouds behind the text.
                - Lighting: Bright, natural daylight creating realistic highlights on the car and soft shadows on the ground.

                PHASE 4: FINAL VISUAL STYLE.
                High-end commercial poster design. Crisp separation between the flat graphic navy blue text and the hyper-realistic 3D automotive photography. Aspect ratio designed for a vertical poster format. --ar 3:4 --v 6.0 --style raw`
    },

    {
        id: 3,
        title: "Chevrolet Malibu | Meadow Dreamscape",
        model: "Grok, Nano or Powerful Ai Model",
        image: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694767/Ingredients_result_xaes5c.jpg",
        fullImage: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694767/Ingredients_result_xaes5c.jpg",
        prompt: "A cinematic fine art automotive photograph of a pearl-white Chevrolet Malibu sedan, positioned at an elegant 3/4 front angle in a serene natural meadow. The car is surrounded by tall feathery pampas grass and delicate wildflowers. In the immediate foreground, soft out-of-focus grass blades create an organic vignette frame. The scene is lit by late afternoon magic hour sunlight, casting soft diffused warm light with beautiful sun flares and light leaks wrapping the car's pearl finish. A gentle mystical ground mist hovers over the meadow floor. The image has an extreme shallow depth of field, f/1.4, rendering the Malibu in pristine sharp focus while the background dissolves into painterly bokeh. The expansive sky above features a soft pastel gradient of blush pink, warm peach, and airy lavender tones. The overall color palette consists of muted sage green and warm gold earth tones, with lifted warm shadows and no harsh blacks. The style mimics 35mm vintage film photography with grain, a soft ethereal glow, and a romantic editorial aesthetic."
    },

    {
        ...
        title: "Chevrolet Malibu | NEW ROADS",
        model: "Grok, Nano or Powerful Ai Model",
        image: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694721/3_ofcimu.jpg",
        fullImage: "https://res.cloudinary.com/ddkd9lxpr/image/upload/v1772694721/3_ofcimu.jpg",
        prompt: "Professional 8K commercial automotive photography for editorial print featuring a pearl-white Chevrolet Malibu sedan. The car is captured from an extreme low worm's-eye angle perspective, dominating the frame and appearing massive. It sits on a dark asphalt road surface. The background is a clear vast blue sky with wispy soft clouds. Strong direct sunlight casts dramatic high-contrast shadows, emphasizing the car's curves and details. Bold graphic typography overlays the scene: the word NEW appears in massive ultra-condensed bold sans-serif on the middle-left edge, and ROADS on the middle-right edge. The text is in solid matte Chevrolet Gold, resembling flat opaque print ink. The car's front tire and bumper partially overlap the text, creating depth. A small minimalist Chevrolet bowtie logo is in the upper corner, and small technical metadata text is at the bottom. The image contrasts flat graphic design with realistic, tack-sharp automotive photography."
    },
